...
-- ---------------------------------------------------------------------------
INSERT INTO libri (utente_id, titolo, autore, anno, descrizione, citta, lat, lon, disponibile) VALUES
-- Giulia Rossi (Roma)
(1, 'Il nome della rosa',          'Umberto Eco',                    1980, 'Giallo storico ambientato in un monastero medievale.',        'Roma',    41.905000, 12.498000, TRUE),
(1, 'Se questo e'' un uomo',        'Primo Levi',                     1947, 'Memoriale della deportazione ad Auschwitz.',                   'Roma',    41.899000, 12.502000, TRUE),
(1, 'Il Gattopardo',               'Giuseppe Tomasi di Lampedusa',   1958, 'Romanzo sul tramonto dell''aristocrazia siciliana.',          'Roma',    41.910000, 12.490000, FALSE),
(1, 'Uno, nessuno e centomila',    'Luigi Pirandello',               1926, 'Romanzo sull''identita'' e la percezione del se''.',          'Roma',    41.930000, 12.520000, TRUE),
-- Marco Bianchi (Milano)
(2, 'I promessi sposi',            'Alessandro Manzoni',             1827, 'Il romanzo storico per eccellenza della letteratura italiana.', 'Milano',  45.466000,  9.188000, TRUE),
(2, 'La coscienza di Zeno',        'Italo Svevo',                    1923, 'Romanzo psicologico in forma di memoriale.',                   'Milano',  45.460000,  9.195000, TRUE),
-- Sofia Esposito (Napoli)
(3, 'L''amica geniale',            'Elena Ferrante',                 2011, 'Storia di amicizia femminile nella Napoli del dopoguerra.',     'Napoli',  40.853000, 14.270000, TRUE),
(3, 'Il giorno della civetta',     'Leonardo Sciascia',              1961, 'Romanzo sulla mafia siciliana.',                               'Napoli',  40.849000, 14.265000, TRUE),
-- Luca Ferrari (Torino)
(4, 'Le citta'' invisibili',       'Italo Calvino',                  1972, 'Dialoghi immaginari tra Marco Polo e Kublai Khan.',            'Torino',  45.072000,  7.685000, TRUE),
(4, 'Tre uomini in barca',         'Jerome K. Jerome',               1889, 'Classico umoristico di un viaggio sul Tamigi.',                'Torino',  45.068000,  7.690000, TRUE),
-- Elena Conti (Firenze)
(5, 'La Divina Commedia',          'Dante Alighieri',                1320, 'Il poema sacro, viaggio nei tre regni dell''oltretomba.',      'Firenze', 43.771000, 11.254000, TRUE),
(5, 'Il Decameron',               'Giovanni Boccaccio',             1353, 'Cento novelle narrate da dieci giovani fiorentini.',           'Firenze', 43.768000, 11.258000, TRUE),
-- Davide Greco (Bologna)
(6, 'Q',                           'Luther Blissett',                1999, 'Romanzo storico ambientato nella Riforma protestante.',        'Bologna', 44.496000, 11.341000, TRUE),
(6, 'Cuore',                       'Edmondo De Amicis',              1886, 'Diario di un alunno nella scuola dell''Italia post-unitaria.', 'Bologna', 44.493000, 11.345000, TRUE);
